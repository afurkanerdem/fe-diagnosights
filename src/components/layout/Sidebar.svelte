<nav id="sidebar" class="lg:min-w-[250px] w-max max-lg:min-w-8">
    ...
    >
        <div class="pt-8 pb-2 px-6 sticky top-0 bg-white min-h-[80px] z-[100]">
                ...
                <img src="/black-logo.png" alt="logo" class="w-[250px]" />
        </div>
        ...
        <div class="py-6 px-6">
            <ul class="space-y-2">
                <li>
                    <a
                        href="#/patient-data"
                        class="menu-item text-[#122023] text-sm flex items-center cursor-pointer hover:bg-gray-100 rounded-md px-3 py-3 transition-all duration-300"
                    >
                ...
                <li>
                    ...
                    >
                        ...
                        <span>Upload Patient Records</span>
                    </a>
                </li>
            </ul>
        </div>
